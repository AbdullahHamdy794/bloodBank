       ...
       <html lang="en" dir="rtl">
           <head>
               ...
               <link rel="icon" href="{{asset("Front/Icon.png")}}">
                       ...
                       <div class="row">
                           <div class="col-md-4">
                               <div class="language">
                                   ...
                                   <a href="contact-us-ltr.html" class="en inactive">EN</a>
                               </div>
                           </div>
                           <div class="col-md-4">
                               <div class="social">
                       ...
                       <div class="container">
                           ...
                           <div class="collapse navbar-collapse" id="navbarNav">
                               <ul class="navbar-nav">
                                   ...
                                   <li class="nav-item">
                                       <a class="nav-link" href="{{url('who-are-you')}}">عن بنك الدم</a>
                                   </li>
                                   <li class="nav-item">
                       ...
                       <div class="row methods">
                           ...
                           <div class="col-md-6">
                               <div class="contact-form">
                                   ...
                                   <div class="fields">
                                       <form method="post"action="{{url('createSetting')}}">
                                        @csrf
