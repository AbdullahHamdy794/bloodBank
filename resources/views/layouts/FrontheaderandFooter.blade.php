                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="language">
                            ...
                            <a href="who-are-us-ltr.html" class="en inactive">EN</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="social">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('/theMain')}}">الرئيسية</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <a href="donation.index" class="donate">
